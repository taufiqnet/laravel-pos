            ...
            <div class="container-fluid">
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form method="POST" action="{{route('update_permission', $permission->id)}}" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                    <div class="row col-md-12">
                                        <div class="col-md-6">
                                            <div class="form-group" style="text-align: left;">
                                                ...
                                                <x-jet-input required placeholder="Enter a Permission Name" id="name" class="form-control" type="text" name="name" value="{{$permission->name}}" autofocus />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select required name="group_id" class="form-control select2" style="width: 100%;">
                                                    <option value="{{$permission->group_id}}">{{$permission->group_name}}</option>
