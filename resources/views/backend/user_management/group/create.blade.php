            ...
            <div class="container-fluid">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title">Create New Permission Group</h3>
                                    ...
                                    <div class="row col-md-12">
                                        <div class="col-md-6">
                                            <div class="form-group" style="text-align: left;">
                                                ...
                                                <x-jet-input required placeholder="Enter a Permission Group Name" id="name" class="form-control" type="text" name="name" :value="old('name')" autofocus />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group" style="text-align: left;">
                                                <x-jet-label value="{{ __('Order No.*') }}" />
                                                <x-jet-input required placeholder="1" id="order_no" class="form-control" type="number" name="order_no" :value="old('order_no')" autofocus />
                                            </div>
                                        </div>
                                    </div>
